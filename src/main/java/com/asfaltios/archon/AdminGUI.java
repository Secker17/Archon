...
public class AdminGUI implements Listener {
    ...
    private void openPlayerManagementGUI(Player player) {
        ...
        gui.setItem(10, createGuiItem(Material.BARRIER, ChatColor.RED + "Kick Player", "Kick a player from the server"));
        gui.setItem(11, createGuiItem(Material.ANVIL, ChatColor.DARK_RED + "Ban Player", "Ban a player from the server"));
        gui.setItem(12, createGuiItem(Material.JUKEBOX, ChatColor.GOLD + "Mute Player", "Mute a player in chat"));
        gui.setItem(13, createGuiItem(Material.ICE, ChatColor.AQUA + "Freeze Player", "Freeze a player"));
        gui.setItem(14, createGuiItem(Material.ENDER_EYE, ChatColor.LIGHT_PURPLE + "Teleport to Player", "Teleport to a player"));
        gui.setItem(15, createGuiItem(Material.FISHING_ROD, ChatColor.YELLOW + "Bring Player", "Teleport a player to you"));
        gui.setItem(16, createGuiItem(Material.BOOK, ChatColor.GREEN + "Inspect Inventory", "View a player's inventory"));
    ...
    private void openServerManagementGUI(Player player) {
        ...
        gui.setItem(10, createGuiItem(Material.CLOCK, ChatColor.YELLOW + "Change Time", "Set the time of day"));
        gui.setItem(11, createGuiItem(Material.COMPASS, ChatColor.BLUE + "Change Weather", "Set the weather"));
        gui.setItem(12, createGuiItem(Material.GRASS_BLOCK, ChatColor.GREEN + "Manage Worlds", "Create or delete worlds"));
        gui.setItem(13, createGuiItem(Material.PAPER, ChatColor.DARK_PURPLE + "Server Stats", "View server statistics"));
        gui.setItem(14, createGuiItem(Material.COMMAND_BLOCK, ChatColor.RED + "Execute Command", "Run a server command"));
        gui.setItem(15, createGuiItem(Material.REPEATER, ChatColor.LIGHT_PURPLE + "Manage Plugins", "Enable or disable plugins"));
    ...
    private void openPersonalToolsGUI(Player player) {
        ...
        gui.setItem(10, createGuiItem(Material.FEATHER, ChatColor.WHITE + "Toggle Fly", "Enable or disable fly mode"));
        gui.setItem(11, createGuiItem(Material.NETHER_STAR, ChatColor.GOLD + "God Mode", "Enable or disable god mode"));
        gui.setItem(12, createGuiItem(Material.GOLDEN_APPLE, ChatColor.RED + "Heal", "Restore health and hunger"));
        gui.setItem(13, createGuiItem(Material.DIAMOND, ChatColor.YELLOW + "Give Item", "Give yourself an item"));
        gui.setItem(14, createGuiItem(Material.ENDER_CHEST, ChatColor.DARK_BLUE + "Ender Chest", "Open your ender chest"));
        gui.setItem(15, createGuiItem(Material.DIAMOND_SWORD, ChatColor.LIGHT_PURPLE + "Toggle Game Mode", "Switch between creative and survival modes"));
    ...
    // Rest of the code, including other methods and event handlers.
    ...
    public void onPlayerSelectorClick(InventoryClickEvent event) {
        ...
        if (!title.startsWith(PLAYER_SELECTOR_TITLE)) return;
        ...
        if (clickedType != Material.PLAYER_HEAD) return;
        ...
        String action = title.substring(title.lastIndexOf('-') + 2); // Extract action from title

        switch (action) {
            case "Kick Player":
                target.kickPlayer("You have been kicked by an administrator.");
                admin.sendMessage(ChatColor.GREEN + "Player " + target.getName() + " has been kicked.");
                break;
            case "Ban Player":
                target.kickPlayer("You have been banned by an administrator.");
                Bukkit.getBanList(org.bukkit.BanList.Type.NAME).addBan(target.getName(), "Banned by an administrator.", null, null);
